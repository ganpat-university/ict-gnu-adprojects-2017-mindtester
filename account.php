...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#"><b>MINDTESTER</b></a>
    </div>
...
if(@$_GET['q']== 3) 
{
$q=mysqli_query($con,"SELECT email,score FROM rank  ORDER BY score DESC " )or die('Error223');
echo  '<div class="panel title">
<table class="table table-striped title1" >
<tr style="color:red"><td><b>Rank</b></td><td><b>E-mail</b></td><td><b>Score</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
...
//$t=$row['time'];
$c++;
echo '<tr><td style="color:#99cc32"><b>'.$c.'</b></td><td>'.$e.'</td><td>'.$s.'</td></tr>';
}
echo '</table></div>';}
?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		 ...
		 <div class="col-md-5">
		<a href="https://www.facebook.com/sunnygkp10" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Sunny Bunny</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917785068889</h4>
		<h4 style="font-family:'typo' ">ABC Cruise & XYZ Avengers</h4>
