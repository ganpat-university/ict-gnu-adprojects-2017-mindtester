...
<title>MINDTESTER || TEST YOUR SKILL </title>
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="name" name="name" placeholder="Enter your name" class="form-control input-md" type="text" pattern="[A-Za-z]{1,20}"required>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Enter your college name" class="form-control input-md" type="text"pattern="[A-Za-z]{1,20}" required>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="../image/LOGO_2.jpg" width=100 height=100 alt="Mind teaser" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="https://www.facebook.com/sunnygkp10" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">ABC Patel</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">abc@gmail.com</h4>
		<h4 style="font-family:'typo' ">XYZ Patel</h4>
		<h4 style="font-family:'typo' ">xyz@gmail.com</h4>
		<h4 style="font-family:'typo' ">Ganpat University</h4></div></div>
		</p>
      </div>
